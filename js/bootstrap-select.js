    ...
    createLi: function () {
      ...
      $selectOptions.each(function (index) {
        ...
        if (isOptgroup && thisData.divider !== true) {
          ...
          mainElements.push(generateLI(generateA(textElement, 'opt ' + optionClass + optGroupClass, inline, href), index, '', optID));
          mainData.push({
          ...
          mainElements.push(generateLI(generateA(textElement, optionClass, inline, href), index));
          mainData.push({
            content: optionContent || text,
            subtext: subtext,
            tokens: tokens,
